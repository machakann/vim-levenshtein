...
function! s:suite.levenshtein() abort
  if has('patch-8.2.5003')
    ...
    call s:assert.equals(
    \ s:bitparallel_vim9.LevenshteinDistance("αβγ", "αβγ"), 0, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.LevenshteinDistance("αβ", "αβγ"), 1, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.LevenshteinDistance("αβγδ", "αβγ"), 1, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.LevenshteinDistance("αβδ", "αβγ"), 1, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.LevenshteinDistance("αγβ", "αβγ"), 2, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.LevenshteinDistance("δεζ", "αβγ"), 3, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.LevenshteinDistance("δεζη", "αβγ"), 4, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.LevenshteinDistance("εζη", "αβγδ"), 4, printf('Failed at line %d', expand('<sflnum>')))
  else
...
function! s:suite.ristricted_damerau_levenshtein() abort
  if has('patch-8.2.5003')
    ...
    call s:assert.equals(
    \ s:bitparallel_vim9.RistrictedDamerauLevenshteinDistance("αβγ", "αβγ"), 0, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.RistrictedDamerauLevenshteinDistance("αβ", "αβγ"), 1, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.RistrictedDamerauLevenshteinDistance("αβγδ", "αβγ"), 1, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.RistrictedDamerauLevenshteinDistance("αβδ", "αβγ"), 1, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.RistrictedDamerauLevenshteinDistance("αγβ", "αβγ"), 1, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.RistrictedDamerauLevenshteinDistance("δεζ", "αβγ"), 3, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.RistrictedDamerauLevenshteinDistance("δεζη", "αβγ"), 4, printf('Failed at line %d', expand('<sflnum>')))

    call s:assert.equals(
    \ s:bitparallel_vim9.RistrictedDamerauLevenshteinDistance("εζη", "αβγδ"), 4, printf('Failed at line %d', expand('<sflnum>')))
